    ...
    def __init__(
        ...
        **kwargs,
        ...
        if freeze_image_encoder:
            ...
            #print("Memory Attention frozen.")
            #for param in self.memory_attention.parameters():
            #    param.requires_grad = False

            #print("Memory Encoder frozen.")
            #for param in self.memory_encoder.parameters():
            #    param.requires_grad = False

            # Example: Freeze other specific learnable components if they exist
            # Ensure these attributes exist before trying to freeze them.
            #if hasattr(self, 'obj_ptr_tpos_proj'):
            #    print("obj_ptr_tpos_proj frozen.")
            #    for param in self.obj_ptr_tpos_proj.parameters():
            #        param.requires_grad = False
            
                
        for name, module in self.named_modules():
            if "decoder" in name:  # Replace with actual decoder module identifier
